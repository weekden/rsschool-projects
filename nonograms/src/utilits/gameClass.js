			...
			for (let j = 0; j < maxWidth; j++) {
				...
				if (mainBoard) {
					...
					if (mainBoard === 'hard') {
						...
						setTableSize('--main-board-size', 360);
					}
				}
				if (maket) {
					if (maket === 'easy') cellClasses.push('cell-maket-easy-size');
					if (maket === 'medium') cellClasses.push('cell-maket-medium-size');
					if (maket === 'hard') cellClasses.push('cell-maket-hard-size');
