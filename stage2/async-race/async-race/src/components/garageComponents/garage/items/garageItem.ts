...
export function createGarageItem(car: Car): HTMLElement {
  ...
  const controls = createItemGarageControl(car);
  const actionButtons = createItemGarageAction(car);
  const carTrack = createCarTrack(car);
...
function createItemGarageControl(car: Car): HTMLElement {
...
function createItemGarageAction(car: Car): HTMLElement {
...
function createCarTrack(car: Car): HTMLElement {
